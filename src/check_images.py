...
def get_input_args():
    ...
    parser.add_argument("-d", "--dir", help="default- 'pet_images/'", default='pet_images/')
    parser.add_argument("-a", "--arch", help="default- resnet or pick any of the following vgg, alexnet, resnet", default='resnet')
    parser.add_argument("-f", "--dogfile", help="default- 'dognames.txt'", default='dognames.txt')
